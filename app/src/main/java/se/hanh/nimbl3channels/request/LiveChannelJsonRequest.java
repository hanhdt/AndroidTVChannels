 ...
 */
public class LiveChannelJsonRequest extends RequestInterface<JSONArray, Void> {

    private final String URL_LIVE_CHANNEL = "1/channels/live.json";

    private int pageIndex = 1;

    public LiveChannelJsonRequest(int page) {
        this.pageIndex = page;
    }
